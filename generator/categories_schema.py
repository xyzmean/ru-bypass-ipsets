...
CATEGORIES = [
    ...
    },
    {
        ...
        # предположено. Без no_subtract из пяти узлов проекта в списке остаются два:
        ...
        # с него роутер берёт пакеты. Список из двух второстепенных узлов хуже, чем
        # отсутствие списка, потому что выглядит рабочим.
        #
        # Плата названа вслух: включивший этот список уводит в туннель 256 адресов Fastly,
        # за которыми живут чужие сайты. Это осознанный выбор человека, а не умолчание —
        # категория выключена по умолчанию.
        "no_subtract": True,
