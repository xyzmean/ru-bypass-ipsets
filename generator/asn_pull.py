...
# импортеры. Вместе — 142 префикса, после свёртки 76 и 10 387 адресов; в выпущенном
# github_cdn.lst их 10 672, потому что к фиду добавлены анонсы AS36459.
#
# Считать надо ИМЕННО после свёртки. Сумма num_addresses по 142 префиксам фида даёт
# 51 383 — впятеро больше, и это не адреса, а двойной счёт: фид перечисляет одни и те же
# сети под несколькими ключами, 36 записей из 142 повторяются дословно, а остальные
# вкладываются друг в друга. Число «около 51 тысячи» стояло здесь ровно по этой причине.
#
